...
INSERT INTO `fruit_admin_user` VALUES (1,'admin','e10adc3949ba59abbe56e057f20f883e','admin','admin@admin.com',0,1419685268,1,1,'系统管理员，勿删！'),(4,'test','e10adc3949ba59abbe56e057f20f883e','test',NULL,1415763083,1418971494,0,1,NULL),(5,'demo','e10adc3949ba59abbe56e057f20f883e','demo',NULL,1417593149,1417597300,0,1,NULL),(7,'test1','e10adc3949ba59abbe56e057f20f883e','ceshi',NULL,1417676700,NULL,0,1,NULL);
...
CREATE TABLE `fruit_order_address` (
  ...
  `_phone` char(11) DEFAULT NULL COMMENT '备用收货人手机',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='订单地址表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fruit_order_custom` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='订单定制表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `fruit_order_custom` VALUES (1,1,1,222.00,1,'我的定制'),(2,2,1,222.00,1,'我的定制'),(3,3,1,222.00,1,'我的定制'),(4,4,1,222.00,1,'我的定制'),(5,5,1,222.00,1,'我的定制'),(6,6,1,222.00,1,'我的定制'),(7,7,1,222.00,1,'我的定制'),(8,8,1,222.00,1,'我的定制'),(9,9,1,222.00,1,'我的定制');
...
CREATE TABLE `fruit_order_custom_goods` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8 COMMENT='订单定制商品表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fruit_order_package` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='订单套餐表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fruit_order_package_goods` (
  ...
  `tag_name` varchar(60) NOT NULL COMMENT '标签名',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 COMMENT='订单套餐商品表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fruit_package_goods` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8 COMMENT='套餐商品表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `fruit_package_goods` VALUES (7,19,1,1),(8,19,2,2),(11,20,3,2),(12,20,4,3),(13,20,1,10),(15,21,5,2),(16,22,5,2),(17,22,6,5),(24,23,5,1),(25,23,6,10);
...
INSERT INTO `fruit_purchase` VALUES (1,0,1,8,1,10,1419392079,1419398403),(2,0,2,8,1,10,1419392779,1419398403),(3,0,3,8,1,10,1419392782,1419398403),(4,0,4,8,1,10,1419392783,1419398403),(5,0,5,8,1,10,1419392785,1419398403),(6,0,6,9,1,10,1419394102,1419398403),(7,0,1,8,1,1,1419392079,1419398403),(8,0,1,8,2,2,1419392079,1419398403),(9,0,2,8,1,1,1419392779,1419398403),(10,0,2,8,2,2,1419392779,1419398403),(11,0,3,8,1,1,1419392782,1419398403),(12,0,3,8,2,2,1419392782,1419398403),(13,0,4,8,1,1,1419392783,1419398403),(14,0,4,8,2,2,1419392783,1419398403),(15,0,5,8,1,1,1419392785,1419398403),(16,0,5,8,2,2,1419392785,1419398403),(17,0,6,9,1,2,1419394102,1419398403),(18,0,6,9,2,4,1419394102,1419398403),(19,0,1,8,1,10,1419392079,1419398403),(20,0,1,8,2,8,1419392079,1419398403),(21,0,1,8,3,6,1419392079,1419398403),(22,0,2,8,1,10,1419392779,1419398403),(23,0,2,8,2,8,1419392779,1419398403),(24,0,2,8,3,6,1419392779,1419398403),(25,0,3,8,1,10,1419392782,1419398403),(26,0,3,8,2,8,1419392782,1419398403),(27,0,3,8,3,6,1419392782,1419398403),(28,0,4,8,1,10,1419392783,1419398403),(29,0,4,8,2,8,1419392783,1419398403),(30,0,4,8,3,6,1419392783,1419398403),(31,0,5,8,1,10,1419392785,1419398403),(32,0,5,8,2,8,1419392785,1419398403),(33,0,5,8,3,6,1419392785,1419398403),(34,0,6,9,1,10,1419394102,1419398403),(35,0,6,9,2,8,1419394102,1419398403),(36,0,6,9,3,6,1419394102,1419398403);
...
-- Dump completed on 2014-12-27 22:11:34
